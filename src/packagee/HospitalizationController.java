...
public class HospitalizationController {
    ...
    public Response requestHospitalization(long patientId, String doctorName, String date, String reason, RoomType roomType, String observations) {
        Patient patient = HospitalData.findPatientById(patientId);
        
        Doctor doctor = null;
        
        for (User u : HospitalData.users) {
